...
# Fixed: Sentiment pipeline forced to run on CPU
SENT = pipeline(
    'sentiment-analysis',
...
if btc < THR['btc_price']: alerts.append('BTC < 100k'); risk_score += 1
...
" + "; ".join(alerts)
    ...
    email_send("WinterWatch ALERT", msg)
